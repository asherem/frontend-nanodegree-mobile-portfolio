...
var resizePizzas = function(size) {
  ...
  */
  ...
  // New code- note how it's taken outside of loop to save resources and repainting
  function changePizzaSizes(size) {
      var pizzaContainer = randomPizza.length;
...
// As noted in README- turn multiple lookups in variables, use getElementById/Class when possible!
...
// Code has been optimized. Below you will find the original code:
